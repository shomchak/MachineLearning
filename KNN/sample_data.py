# Sample data taken from Burak Kanber's blog 
...
weights = {'rooms':1,'area':1}
unknowndata = {'rooms':8,'area':1250}
unknown = Node(unknowndata,'unknown')

def run():
	k=5
	nodeList = makeNodeList(data)
	nodeList.normalizeData(weights)
	nodeList.classify(unknown,k)
